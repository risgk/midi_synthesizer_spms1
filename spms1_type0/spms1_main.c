...
static const char *const sp_sym_names[50] = {(&("\xff" "initialize")[1]), (&("\xff" "set_waveform")[1]), (&("\xff" "set_modulation_amount")[1]), (&("\xff" "set_coarse_tune")[1]), (&("\xff" "set_fine_tune")[1]), (&("\xff" "process")[1]), (&("\xff" "pitch_to_freq_fast")[1]), (&("\xff" "poly_blep")[1]), (&("\xff" "set_cutoff")[1]), (&("\xff" "set_gain")[1]), (&("\xff" "set_resonance")[1]), (&("\xff" "cutoff_to_freq_fast")[1]), (&("\xff" "update_coefficients")[1]), (&("\xff" "soft_clip")[1]), (&("\xff" "set_attack")[1]), (&("\xff" "set_decay")[1]), (&("\xff" "set_sustain")[1]), (&("\xff" "update_coefficients_full")[1]), (&("\xff" "calculate_exp_fast")[1]), (&("\xff" "set_rate")[1]), (&("\xff" "rate_to_freq_fast")[1]), (&("\xff" "set_level_1")[1]), (&("\xff" "set_level_2")[1]), (&("\xff" "set_invert_1")[1]), (&("\xff" "set_invert_2")[1]), (&("\xff" "set_midi_note_on_pitch")[1]), (&("\xff" "uint8")[1]), (&("\xff" "void")[1]), (&("\xff" "get_midi_note_on_pitch")[1]), (&("\xff" "set_midi_note_on_state")[1]), (&("\xff" "get_midi_note_on_state")[1]), (&("\xff" "set_midi_cc_value")[1]), (&("\xff" "get_midi_cc_value")[1]), (&("\xff" "set_midi_nrpn_value")[1]), (&("\xff" "int32")[1]), (&("\xff" "get_midi_nrpn_value")[1]), (&("\xff" "set_sample_rate")[1]), (&("\xff" "get_sample_rate")[1]), (&("\xff" "set_audio_buffers")[1]), (&("\xff" "get_audio_buffers")[1]), (&("\xff" "set_audio_buffer_words")[1]), (&("\xff" "get_audio_buffer_words")[1]), (&("\xff" "start_audio")[1]), (&("\xff" "stop_audio")[1]), (&("\xff" "write_to_audio_buffer")[1]), (&("\xff" "float")[1]), (&("\xff" "start_debug_measure")[1]), (&("\xff" "stop_debug_measure")[1]), (&("\xff" "cc_to_ratio")[1]), (&("\xff" "cc_slot")[1])};
static const char *sp_dyn_syms[SP_DYN_SYMS_MAX]; static int sp_ndyn = 0;
static const char *sp_sym_to_s(sp_sym id){if(id>=0&&id<50)return sp_sym_names[id];if(id>=50&&id<50+sp_ndyn)return sp_dyn_syms[id-50];return "";}
static sp_sym sp_sym_intern(const char *s){for(int i=0;i<50;i++)if(strcmp(sp_sym_names[i],s)==0)return (sp_sym)i;for(int i=0;i<sp_ndyn;i++)if(strcmp(sp_dyn_syms[i],s)==0)return (sp_sym)(50+i);if(sp_ndyn<SP_DYN_SYMS_MAX){sp_dyn_syms[sp_ndyn]=sp_str_dup_external(s);return (sp_sym)(50+sp_ndyn++);}return (sp_sym)0;}
...
#line 140 "spms1_main.rb"
  cst_SIGNAL_MIXER_1_INVERT_1 = 47LL;
#line 141 "spms1_main.rb"
  cst_SIGNAL_MIXER_1_LEVEL_2 = 48LL;
#line 142 "spms1_main.rb"
  cst_SIGNAL_MIXER_1_INVERT_2 = 49LL;
#line 143 "spms1_main.rb"
  cst_SIGNAL_MIXER_2_LEVEL_1 = 50LL;
#line 144 "spms1_main.rb"
  cst_SIGNAL_MIXER_2_INVERT_1 = 51LL;
#line 145 "spms1_main.rb"
  cst_SIGNAL_MIXER_2_LEVEL_2 = 52LL;
#line 146 "spms1_main.rb"
  cst_SIGNAL_MIXER_2_INVERT_2 = 53LL;
#line 147 "spms1_main.rb"
  cst_SIGNAL_MIXER_3_LEVEL_1 = 54LL;
#line 148 "spms1_main.rb"
  cst_SIGNAL_MIXER_3_INVERT_1 = 55LL;
#line 149 "spms1_main.rb"
  cst_SIGNAL_MIXER_3_LEVEL_2 = 56LL;
#line 150 "spms1_main.rb"
  cst_SIGNAL_MIXER_3_INVERT_2 = 57LL;
#line 151 "spms1_main.rb"
  cst_SIGNAL_MIXER_4_LEVEL_1 = 58LL;
#line 152 "spms1_main.rb"
  cst_SIGNAL_MIXER_4_INVERT_1 = 59LL;
#line 153 "spms1_main.rb"
  cst_SIGNAL_MIXER_4_LEVEL_2 = 60LL;
#line 154 "spms1_main.rb"
  cst_SIGNAL_MIXER_4_INVERT_2 = 61LL;
#line 155 "spms1_main.rb"
  cst_SIGNAL_MIXER_5_LEVEL_1 = 62LL;
#line 156 "spms1_main.rb"
  cst_SIGNAL_MIXER_5_INVERT_1 = 63LL;
#line 157 "spms1_main.rb"
  cst_SIGNAL_MIXER_5_LEVEL_2 = 64LL;
#line 158 "spms1_main.rb"
  cst_SIGNAL_MIXER_5_INVERT_2 = 65LL;
#line 160 "spms1_main.rb"
  cst_SIGNAL_PITCH = 66LL;
#line 161 "spms1_main.rb"
  cst_SIGNAL_GATE = 67LL;
...
#line 485 "spms1_main.rb"
  int _gcb167 = sp_gc_nroots; (void)_gcb167;
...
#line 672 "spms1_main.rb"
      mrb_float _t335 = sp_FloatArray_get(lv_signals, lv_source_osc_1_waveform);
      sp_Osc_set_waveform((sp_Osc *)lv_osc_1, _t335);
#line 673 "spms1_main.rb"
      mrb_float _t336 = sp_FloatArray_get(lv_signals, lv_source_osc_1_mod_amount);
      sp_Osc_set_modulation_amount((sp_Osc *)lv_osc_1, _t336);
#line 674 "spms1_main.rb"
      mrb_float _t337 = sp_FloatArray_get(lv_signals, lv_source_osc_1_coarse_tune);
      sp_Osc_set_coarse_tune((sp_Osc *)lv_osc_1, _t337);
#line 675 "spms1_main.rb"
      mrb_float _t338 = sp_FloatArray_get(lv_signals, lv_source_osc_1_fine_tune);
      sp_Osc_set_fine_tune((sp_Osc *)lv_osc_1, _t338);
#line 676 "spms1_main.rb"
      mrb_float _t339 = sp_FloatArray_get(lv_signals, lv_source_osc_2_waveform);
      sp_Osc_set_waveform((sp_Osc *)lv_osc_2, _t339);
#line 677 "spms1_main.rb"
      mrb_float _t340 = sp_FloatArray_get(lv_signals, lv_source_osc_2_mod_amount);
      sp_Osc_set_modulation_amount((sp_Osc *)lv_osc_2, _t340);
#line 678 "spms1_main.rb"
      mrb_float _t341 = sp_FloatArray_get(lv_signals, lv_source_osc_2_coarse_tune);
      sp_Osc_set_coarse_tune((sp_Osc *)lv_osc_2, _t341);
#line 679 "spms1_main.rb"
      mrb_float _t342 = sp_FloatArray_get(lv_signals, lv_source_osc_2_fine_tune);
      sp_Osc_set_fine_tune((sp_Osc *)lv_osc_2, _t342);
#line 680 "spms1_main.rb"
      mrb_float _t343 = sp_FloatArray_get(lv_signals, lv_source_filter_1_cutoff);
      sp_Filter_set_cutoff((sp_Filter *)lv_filter_1, _t343);
#line 681 "spms1_main.rb"
      mrb_float _t344 = sp_FloatArray_get(lv_signals, lv_source_filter_1_resonance);
      sp_Filter_set_resonance((sp_Filter *)lv_filter_1, _t344);
#line 682 "spms1_main.rb"
      mrb_float _t345 = sp_FloatArray_get(lv_signals, lv_source_filter_1_mod_amount);
      sp_Filter_set_modulation_amount((sp_Filter *)lv_filter_1, _t345);
#line 683 "spms1_main.rb"
      mrb_float _t346 = sp_FloatArray_get(lv_signals, lv_source_filter_1_gain);
      sp_Filter_set_gain((sp_Filter *)lv_filter_1, _t346);
#line 684 "spms1_main.rb"
      mrb_float _t347 = sp_FloatArray_get(lv_signals, lv_source_filter_2_cutoff);
      sp_Filter_set_cutoff((sp_Filter *)lv_filter_2, _t347);
#line 685 "spms1_main.rb"
      mrb_float _t348 = sp_FloatArray_get(lv_signals, lv_source_filter_2_resonance);
      sp_Filter_set_resonance((sp_Filter *)lv_filter_2, _t348);
#line 686 "spms1_main.rb"
      mrb_float _t349 = sp_FloatArray_get(lv_signals, lv_source_filter_2_mod_amount);
      sp_Filter_set_modulation_amount((sp_Filter *)lv_filter_2, _t349);
#line 687 "spms1_main.rb"
      mrb_float _t350 = sp_FloatArray_get(lv_signals, lv_source_filter_2_gain);
      sp_Filter_set_gain((sp_Filter *)lv_filter_2, _t350);
#line 688 "spms1_main.rb"
      mrb_float _t351 = sp_FloatArray_get(lv_signals, lv_source_amp_1_gain);
      sp_Amp_set_gain((sp_Amp *)lv_amp_1, _t351);
#line 689 "spms1_main.rb"
      mrb_float _t352 = sp_FloatArray_get(lv_signals, lv_source_amp_2_gain);
      sp_Amp_set_gain((sp_Amp *)lv_amp_2, _t352);
#line 690 "spms1_main.rb"
      mrb_float _t353 = sp_FloatArray_get(lv_signals, lv_source_env_gen_1_attack);
      sp_EnvGen_set_attack((sp_EnvGen *)lv_env_gen_1, _t353);
#line 691 "spms1_main.rb"
      mrb_float _t354 = sp_FloatArray_get(lv_signals, lv_source_env_gen_1_decay);
      sp_EnvGen_set_decay((sp_EnvGen *)lv_env_gen_1, _t354);
#line 692 "spms1_main.rb"
      mrb_float _t355 = sp_FloatArray_get(lv_signals, lv_source_env_gen_1_sustain);
      sp_EnvGen_set_sustain((sp_EnvGen *)lv_env_gen_1, _t355);
#line 693 "spms1_main.rb"
      mrb_float _t356 = sp_FloatArray_get(lv_signals, lv_source_env_gen_2_attack);
      sp_EnvGen_set_attack((sp_EnvGen *)lv_env_gen_2, _t356);
#line 694 "spms1_main.rb"
      mrb_float _t357 = sp_FloatArray_get(lv_signals, lv_source_env_gen_2_decay);
      sp_EnvGen_set_decay((sp_EnvGen *)lv_env_gen_2, _t357);
#line 695 "spms1_main.rb"
      mrb_float _t358 = sp_FloatArray_get(lv_signals, lv_source_env_gen_2_sustain);
      sp_EnvGen_set_sustain((sp_EnvGen *)lv_env_gen_2, _t358);
#line 696 "spms1_main.rb"
      mrb_float _t359 = sp_FloatArray_get(lv_signals, lv_source_lfo_1_rate);
      sp_LFO_set_rate((sp_LFO *)lv_lfo_1, _t359);
#line 697 "spms1_main.rb"
      mrb_float _t360 = sp_FloatArray_get(lv_signals, lv_source_lfo_2_rate);
      sp_LFO_set_rate((sp_LFO *)lv_lfo_2, _t360);
#line 698 "spms1_main.rb"
      mrb_float _t361 = sp_FloatArray_get(lv_signals, lv_source_mixer_1_level_1);
      sp_Mixer_set_level_1((sp_Mixer *)lv_mixer_1, _t361);
#line 699 "spms1_main.rb"
      mrb_float _t362 = sp_FloatArray_get(lv_signals, lv_source_mixer_1_invert_1);
      sp_Mixer_set_invert_1((sp_Mixer *)lv_mixer_1, _t362);
#line 700 "spms1_main.rb"
      mrb_float _t363 = sp_FloatArray_get(lv_signals, lv_source_mixer_1_level_2);
      sp_Mixer_set_level_2((sp_Mixer *)lv_mixer_1, _t363);
#line 701 "spms1_main.rb"
      mrb_float _t364 = sp_FloatArray_get(lv_signals, lv_source_mixer_1_invert_2);
      sp_Mixer_set_invert_2((sp_Mixer *)lv_mixer_1, _t364);
#line 702 "spms1_main.rb"
      mrb_float _t365 = sp_FloatArray_get(lv_signals, lv_source_mixer_2_level_1);
      sp_Mixer_set_level_1((sp_Mixer *)lv_mixer_2, _t365);
#line 703 "spms1_main.rb"
      mrb_float _t366 = sp_FloatArray_get(lv_signals, lv_source_mixer_2_invert_1);
      sp_Mixer_set_invert_1((sp_Mixer *)lv_mixer_2, _t366);
#line 704 "spms1_main.rb"
      mrb_float _t367 = sp_FloatArray_get(lv_signals, lv_source_mixer_2_level_2);
      sp_Mixer_set_level_2((sp_Mixer *)lv_mixer_2, _t367);
#line 705 "spms1_main.rb"
      mrb_float _t368 = sp_FloatArray_get(lv_signals, lv_source_mixer_2_invert_2);
      sp_Mixer_set_invert_2((sp_Mixer *)lv_mixer_2, _t368);
#line 706 "spms1_main.rb"
      mrb_float _t369 = sp_FloatArray_get(lv_signals, lv_source_mixer_3_level_1);
      sp_Mixer_set_level_1((sp_Mixer *)lv_mixer_3, _t369);
#line 707 "spms1_main.rb"
      mrb_float _t370 = sp_FloatArray_get(lv_signals, lv_source_mixer_3_invert_1);
      sp_Mixer_set_invert_1((sp_Mixer *)lv_mixer_3, _t370);
#line 708 "spms1_main.rb"
      mrb_float _t371 = sp_FloatArray_get(lv_signals, lv_source_mixer_3_level_2);
      sp_Mixer_set_level_2((sp_Mixer *)lv_mixer_3, _t371);
#line 709 "spms1_main.rb"
      mrb_float _t372 = sp_FloatArray_get(lv_signals, lv_source_mixer_3_invert_2);
      sp_Mixer_set_invert_2((sp_Mixer *)lv_mixer_3, _t372);
#line 710 "spms1_main.rb"
      mrb_float _t373 = sp_FloatArray_get(lv_signals, lv_source_mixer_4_level_1);
      sp_Mixer_set_level_1((sp_Mixer *)lv_mixer_4, _t373);
#line 711 "spms1_main.rb"
      mrb_float _t374 = sp_FloatArray_get(lv_signals, lv_source_mixer_4_invert_1);
      sp_Mixer_set_invert_1((sp_Mixer *)lv_mixer_4, _t374);
#line 712 "spms1_main.rb"
      mrb_float _t375 = sp_FloatArray_get(lv_signals, lv_source_mixer_4_level_2);
      sp_Mixer_set_level_2((sp_Mixer *)lv_mixer_4, _t375);
#line 713 "spms1_main.rb"
      mrb_float _t376 = sp_FloatArray_get(lv_signals, lv_source_mixer_4_invert_2);
      sp_Mixer_set_invert_2((sp_Mixer *)lv_mixer_4, _t376);
#line 714 "spms1_main.rb"
      mrb_float _t377 = sp_FloatArray_get(lv_signals, lv_source_mixer_5_level_1);
      sp_Mixer_set_level_1((sp_Mixer *)lv_mixer_5, _t377);
#line 715 "spms1_main.rb"
      mrb_float _t378 = sp_FloatArray_get(lv_signals, lv_source_mixer_5_invert_1);
      sp_Mixer_set_invert_1((sp_Mixer *)lv_mixer_5, _t378);
#line 716 "spms1_main.rb"
      mrb_float _t379 = sp_FloatArray_get(lv_signals, lv_source_mixer_5_level_2);
      sp_Mixer_set_level_2((sp_Mixer *)lv_mixer_5, _t379);
#line 717 "spms1_main.rb"
      mrb_float _t380 = sp_FloatArray_get(lv_signals, lv_source_mixer_5_invert_2);
      sp_Mixer_set_invert_2((sp_Mixer *)lv_mixer_5, _t380);
...
#line 726 "spms1_main.rb"
          mrb_int _t381 = lv_module_id;
          if ((_t381 == cst_MODULE_ENV_GEN_1)) {
#line 728 "spms1_main.rb"
            mrb_float _t382 = sp_FloatArray_get(lv_signals, lv_source_env_gen_1_gate);
            sp_FloatArray_set(lv_signals, cst_SIGNAL_ENV_GEN_1_OUTPUT, sp_EnvGen_process((sp_EnvGen *)lv_env_gen_1, _t382));
          }
          else if ((_t381 == cst_MODULE_ENV_GEN_2)) {
#line 730 "spms1_main.rb"
            mrb_float _t383 = sp_FloatArray_get(lv_signals, lv_source_env_gen_2_gate);
            sp_FloatArray_set(lv_signals, cst_SIGNAL_ENV_GEN_2_OUTPUT, sp_EnvGen_process((sp_EnvGen *)lv_env_gen_2, _t383));
          }
          else if ((_t381 == cst_MODULE_LFO_1)) {
#line 732 "spms1_main.rb"
            sp_FloatArray_set(lv_signals, cst_SIGNAL_LFO_1_OUTPUT, sp_LFO_process((sp_LFO *)lv_lfo_1));
          }
          else if ((_t381 == cst_MODULE_LFO_2)) {
#line 734 "spms1_main.rb"
            sp_FloatArray_set(lv_signals, cst_SIGNAL_LFO_2_OUTPUT, sp_LFO_process((sp_LFO *)lv_lfo_2));
          }
          else if ((_t381 == cst_MODULE_OSC_1)) {
#line 736 "spms1_main.rb"
            mrb_float _t384 = sp_FloatArray_get(lv_signals, lv_source_osc_1_pitch);
            mrb_float _t385 = sp_FloatArray_get(lv_signals, lv_source_osc_1_mod);
            sp_FloatArray_set(lv_signals, cst_SIGNAL_OSC_1_OUTPUT, sp_Osc_process((sp_Osc *)lv_osc_1, _t384, _t385));
          }
          else if ((_t381 == cst_MODULE_OSC_2)) {
#line 738 "spms1_main.rb"
            mrb_float _t386 = sp_FloatArray_get(lv_signals, lv_source_osc_2_pitch);
            mrb_float _t387 = sp_FloatArray_get(lv_signals, lv_source_osc_2_mod);
            sp_FloatArray_set(lv_signals, cst_SIGNAL_OSC_2_OUTPUT, sp_Osc_process((sp_Osc *)lv_osc_2, _t386, _t387));
          }
          else if ((_t381 == cst_MODULE_FILTER_1)) {
#line 740 "spms1_main.rb"
            mrb_float _t388 = sp_FloatArray_get(lv_signals, lv_source_filter_1_audio);
            mrb_float _t389 = sp_FloatArray_get(lv_signals, lv_source_filter_1_mod);
            sp_FloatArray_set(lv_signals, cst_SIGNAL_FILTER_1_OUTPUT, sp_Filter_process((sp_Filter *)lv_filter_1, _t388, _t389));
          }
          else if ((_t381 == cst_MODULE_FILTER_2)) {
#line 742 "spms1_main.rb"
            mrb_float _t390 = sp_FloatArray_get(lv_signals, lv_source_filter_2_audio);
            mrb_float _t391 = sp_FloatArray_get(lv_signals, lv_source_filter_2_mod);
            sp_FloatArray_set(lv_signals, cst_SIGNAL_FILTER_2_OUTPUT, sp_Filter_process((sp_Filter *)lv_filter_2, _t390, _t391));
          }
          else if ((_t381 == cst_MODULE_AMP_1)) {
#line 744 "spms1_main.rb"
            mrb_float _t392 = sp_FloatArray_get(lv_signals, lv_source_amp_1_audio);
            mrb_float _t393 = sp_FloatArray_get(lv_signals, lv_source_amp_1_mod);
            sp_FloatArray_set(lv_signals, cst_SIGNAL_AMP_1_OUTPUT, sp_Amp_process((sp_Amp *)lv_amp_1, _t392, _t393));
          }
          else if ((_t381 == cst_MODULE_AMP_2)) {
#line 746 "spms1_main.rb"
            mrb_float _t394 = sp_FloatArray_get(lv_signals, lv_source_amp_2_audio);
            mrb_float _t395 = sp_FloatArray_get(lv_signals, lv_source_amp_2_mod);
            sp_FloatArray_set(lv_signals, cst_SIGNAL_AMP_2_OUTPUT, sp_Amp_process((sp_Amp *)lv_amp_2, _t394, _t395));
          }
          else if ((_t381 == cst_MODULE_MIXER_1)) {
#line 748 "spms1_main.rb"
            mrb_float _t396 = sp_FloatArray_get(lv_signals, lv_source_mixer_1_in_1);
            mrb_float _t397 = sp_FloatArray_get(lv_signals, lv_source_mixer_1_in_2);
            sp_FloatArray_set(lv_signals, cst_SIGNAL_MIXER_1_OUTPUT, sp_Mixer_process((sp_Mixer *)lv_mixer_1, _t396, _t397));
          }
          else if ((_t381 == cst_MODULE_MIXER_2)) {
#line 750 "spms1_main.rb"
            mrb_float _t398 = sp_FloatArray_get(lv_signals, lv_source_mixer_2_in_1);
            mrb_float _t399 = sp_FloatArray_get(lv_signals, lv_source_mixer_2_in_2);
            sp_FloatArray_set(lv_signals, cst_SIGNAL_MIXER_2_OUTPUT, sp_Mixer_process((sp_Mixer *)lv_mixer_2, _t398, _t399));
          }
          else if ((_t381 == cst_MODULE_MIXER_3)) {
#line 752 "spms1_main.rb"
            mrb_float _t400 = sp_FloatArray_get(lv_signals, lv_source_mixer_3_in_1);
            mrb_float _t401 = sp_FloatArray_get(lv_signals, lv_source_mixer_3_in_2);
            sp_FloatArray_set(lv_signals, cst_SIGNAL_MIXER_3_OUTPUT, sp_Mixer_process((sp_Mixer *)lv_mixer_3, _t400, _t401));
          }
          else if ((_t381 == cst_MODULE_MIXER_4)) {
#line 754 "spms1_main.rb"
            mrb_float _t402 = sp_FloatArray_get(lv_signals, lv_source_mixer_4_in_1);
            mrb_float _t403 = sp_FloatArray_get(lv_signals, lv_source_mixer_4_in_2);
            sp_FloatArray_set(lv_signals, cst_SIGNAL_MIXER_4_OUTPUT, sp_Mixer_process((sp_Mixer *)lv_mixer_4, _t402, _t403));
          }
          else if ((_t381 == cst_MODULE_MIXER_5)) {
#line 756 "spms1_main.rb"
            mrb_float _t404 = sp_FloatArray_get(lv_signals, lv_source_mixer_5_in_1);
            mrb_float _t405 = sp_FloatArray_get(lv_signals, lv_source_mixer_5_in_2);
            sp_FloatArray_set(lv_signals, cst_SIGNAL_MIXER_5_OUTPUT, sp_Mixer_process((sp_Mixer *)lv_mixer_5, _t404, _t405));
          }
...
#line 768 "spms1_main.rb"
      for (mrb_int _t407 = 0; _t407 < cst_AUDIO_BUFFER_WORDS; _t407++) {
        lv_i__bp6049 = _t407;
#line 769 "spms1_main.rb"
        (write_to_audio_buffer(((float)(sp_FloatArray_get(lv_audio_buffer, lv_i__bp6049))), ((float)(sp_FloatArray_get(lv_audio_buffer, lv_i__bp6049)))), (mrb_int)0);
      }
    }
    sp_exc_top--;
  }
