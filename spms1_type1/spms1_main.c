...
#line 659 "spms1_main.rb"
        (write_to_audio_buffer(((float)(sp_FloatArray_get(lv_audio_buffer, lv_i__bp5419))), ((float)(sp_FloatArray_get(lv_audio_buffer, lv_i__bp5419)))), (mrb_int)0);
      }
    }
    sp_exc_top--;
  }
