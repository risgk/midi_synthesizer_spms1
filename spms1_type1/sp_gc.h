...
/* Lowered from Spinel's 65536 for the MCU, where sp_gc_roots costs 4 bytes a slot of SRAM whether
   the slot is used or not: 65536 of them is 262KB. SPMS-1 allocates nothing per sample and
   measures 21 roots in use, and the sketch prints the live and peak counts to the debug UART so
   that stays visible. Raise this before adding anything that nests roots deeply. */
#ifndef SP_GC_STACK_MAX
#define SP_GC_STACK_MAX 1024
#endif
